...
def get_connection_string() -> str:
    ...
    1. CLAUDE2000_DB_URL - canonical name, generated by wizard
    2. DATABASE_URL - backwards compatible
    3. CLAUDE2000_POSTGRES_URL - legacy (hooks)
    ...
    # Check env vars in priority order (CLAUDE2000_DB_URL is canonical)
    url = (
        os.environ.get("CLAUDE2000_DB_URL")
        or os.environ.get("DATABASE_URL")
        or os.environ.get("CLAUDE2000_POSTGRES_URL")
    )
    ...
    if _is_production():
        raise ValueError(
            "CLAUDE2000_DB_URL must be set in production mode. "
